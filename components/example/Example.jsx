...
class Example extends React.Component {
  ...
  toggleEditMotto() {
    console.log("editing Motto", this.state.editingMotto);
    if (this.state.editingMotto) {
      this.setState({ editingMotto: false });
    } else {
      this.setState({ editingMotto: true });
    }
  }
        ...
        <div className="motto-update">
          {
            ...
            <div>
              ...
              >
                {this.state.editingMotto ? "Save " : "Edit "} motto
              </button>
            </div>
          }
        </div>
